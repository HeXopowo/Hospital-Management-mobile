...
public class Doctor implements Serializable { // Добавлен implements Serializable
    ...
    public Doctor(String firstName, String lastName, String specialization,
                  String roomNumber, String schedule, String email) {
    ...
    public void setDoctorId(int doctorId) {
        if (doctorId < 0) {
            throw new IllegalArgumentException("ID врача не может быть отрицательным");
        }
    ...
    public boolean equals(Object o) {
        ...
        return doctorId == doctor.doctorId &&
                ...
                roomNumber.equals(doctor.roomNumber) &&
                schedule.equals(doctor.schedule) &&
